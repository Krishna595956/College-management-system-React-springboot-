...
const AddStudent = () => {
  ...
  const validateForm = () => {
    ...
    if (formsData.image && !/\.(jpg|jpeg|png)$/i.test(formsData.image.name)) {
      newErrors.image = "Please select a valid image file (jpg, jpeg, png, gif)";
    }
...
const navigateTo=useNavigate()
  const handleSubmit = async (e) => {
    ...
    try {
      api.post("/auth/signup", formData, bearerHeader).then((res) =>{toast.success(res.data.msg)
        getAllStudents()
      return navigateTo('/admin/student')}).catch((err) => toast.error
            ...
            <div className="flex flex-col border rounded-lg border-gray-300 p-6 shadow-lg shadow-gray-300">
              <div className="">
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded-lg focus:outline-none ${errors.name ? 'border-red-500' : 'border-gray-300'} focus:bg-purple-100 focus:border-green-300 caret-green-400`}
                />
              ...
              <div className="block">
                ...
                <input
                  ...
                  name="email"
                  className={`w-full border p-2 rounded-lg focus:outline-none ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:bg-purple-100 focus:border-green-300 caret-green-400`}
                />
              ...
              <div className="block">
                ...
                <input
                  ...
                  onChange={handleChange}
                  name="mobileNumber"
                  className={`w-full border p-2 rounded-lg focus:outline-none ${errors.mobileNumber ? 'border-red-500' : 'border-gray-300'} focus:bg-purple-100 focus:border-green-300 caret-green-400`}
                />
              ...
              <div className="block">
                ...
                <input
                  ...
                  name="password"
                  className={`w-full border p-2 rounded-lg focus:outline-none ${errors.password ? 'border-red-500' : 'border-gray-300'} focus:bg-purple-100 focus:border-green-300 caret-green-400`}
                />
