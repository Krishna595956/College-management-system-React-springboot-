...
const ViewTransactionAdmin = () => {
  const {payments, allPayments}=useCollege()
  return (
    <div>
        <div className="">
            <h1 className='text-2xl font-bold text-center'>All Transaction</h1>
            <ul>
               {allPayments?.map((item)=> <li className='border-b border-gray-300 p-3 flex justify-between items-center'>
...
export default ViewTransactionAdmin